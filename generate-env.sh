...
LLM_API_KEY_DOC_METADATA_GENERATION=$AZURE_OPENAI_API_KEY

LLM_API_PROVIDER_DOC_STRUCTURE_GENERATION=azure-openai
LLM_API_KEY_DOC_STRUCTURE=$AZURE_OPENAI_API_KEY

LLM_API_PROVIDER_ELEM_SEARCH=azure-openai
LLM_API_KEY_ELEM_SEARCH=$AZURE_OPENAI_API_KEY

LLM_API_PROVIDER_DATA_EXTRACTION=azure-openai
LLM_API_KEY_DATA_EXTRACTION=$AZURE_OPENAI_API_KEY

LLM_API_PROVIDER_DATA_SOURCE_OVERVIEW_GENERATOR=azure-openai
LLM_API_KEY_DATA_SOURCE_OVERVIEW_GENERATOR=$AZURE_OPENAI_API_KEY
...
LLM_API_PROVIDER_AUTO_TUNER=azure-openai
MODEL_AUTO_TUNER=gpt-4o-2024-08-06
LLM_API_KEY_AUTO_TUNER=$AZURE_OPENAI_API_KEY
MODEL_DATABASE_TRANSFORMATION=gpt-4o-2024-08-06

LOAD_FROM_FILE=False

#Evaluation
LLM_API_PROVIDER_ANSWER_EVALUATION=azure-openai
LLM_API_KEY_ANSWER_EVALUATION=$AZURE_OPENAI_API_KEY

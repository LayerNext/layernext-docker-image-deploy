...
DB_CPU_LIMIT=$ANALYTICS_DB_CPU_LIMIT
DB_MEMORY_LIMIT=$ANALYTICS_DB_MEMORY_LIMIT

#Analytics app
ANALYSIS_CPU_LIMIT=$ANALYTICS_APP_CPU_LIMIT
ANALYSIS_MEMORY_LIMIT=$ANALYTICS_APP_MEMORY_LIMIT
